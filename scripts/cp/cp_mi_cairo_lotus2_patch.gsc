...
{
	spawncollision("collision_clip_wall_512x512x10", "collider", (-7680, 3451, 3720), VectorScale((0, 1, 0), 270));
	spawncollision("collision_clip_wall_512x512x10", "collider", (-7168, 3451, 3720), VectorScale((0, 1, 0), 270));
	spawncollision("collision_clip_wall_512x512x10", "collider", (-6656, 3451, 3720), VectorScale((0, 1, 0), 270));
	spawncollision("collision_clip_wall_512x512x10", "collider", (-6144, 3451, 3720), VectorScale((0, 1, 0), 270));
	spawncollision("collision_clip_wall_512x512x10", "collider", (-5632, 3451, 3720), VectorScale((0, 1, 0), 270));
	...
	spawncollision("collision_clip_wall_512x512x10", "collider", (-4972, 2683, 3720), VectorScale((0, 1, 0), 90));
	spawncollision("collision_clip_wall_512x512x10", "collider", (-4460, 2683, 3720), VectorScale((0, 1, 0), 90));
	...
	spawncollision("collision_player_wall_256x256x10", "collider", (-8743, -229, 14977), VectorScale((0, 1, 0), 270));
	spawncollision("collision_player_wall_256x256x10", "collider", (-8512, -229, 14977), VectorScale((0, 1, 0), 270));
