...
function init()
{
	...
	clientfield::register("scriptmover", "pickuprotate", 1, 1, "int", &function_2694ab64, 0, 0);
...
/*
	...
	Flags: None
*/
function function_2694ab64(localClientNum, oldVal, newVal, bNewEnt, bInitialSnap, fieldName, bWasTimeJump)
{
	if(!isdefined(self.fakemodel))
	{
		return;
