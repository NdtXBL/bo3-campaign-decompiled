...
function function_b8f105c6(a_ents)
{
	...
	a_ents["zurich_intro_sitrep_guy"] thread function_d8d72142();
	vh_vtol = GetVehicleNode("street_intro_vtol", "targetname") namespace_8e9083ff::function_a569867c(undefined, &namespace_1beb9396::function_b8380f70);
...
function function_d8d72142()
{
	...
	for(i = 0; i < 36; i++)
	{
		var_24593fb7 = Array::random(var_3f44bbce);
		a_s_targets = struct::get_array(var_24593fb7.target);
		...
		MagicBullet(w_weapon, var_24593fb7.origin + var_8d661004, s_target.origin + var_8d661004);
...
function function_6e68a9b()
{
	...
	while(1)
	{
		for(a_ai = namespace_8e9083ff::function_33ec653f("intro_street_robots_spawn_manager", undefined, undefined, &function_56e5aa4d); a_ai.size > 1;  = namespace_8e9083ff::function_33ec653f("intro_street_robots_spawn_manager", undefined, undefined, &function_56e5aa4d))
		{
...
function function_ddcc04ff()
{
	...
	var_f3200b3f vehicle_ai::function_81b6f1ac();
...
/*
	...
	Flags: None
*/
function function_74df00be(n_dist)
{
	if(!isdefined(n_dist))
	{
		n_dist = 512;
