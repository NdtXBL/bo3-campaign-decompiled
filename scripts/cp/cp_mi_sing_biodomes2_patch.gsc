...
function function_7403e82b()
{
	...
	spawncollision("collision_clip_64x64x256", "collider", (-5234, -226, -417), VectorScale((1, 0, 0), 295));
	spawncollision("collision_clip_256x256x256", "collider", (-3273, 502, -318), VectorScale((1, 0, 0), 338));
	spawncollision("collision_clip_wall_512x512x10", "collider", (340, 12284, 1056), VectorScale((0, 1, 0), 270));
	spawncollision("collision_clip_wall_512x512x10", "collider", (772, 12272, 1056), VectorScale((0, 1, 0), 270));
}
