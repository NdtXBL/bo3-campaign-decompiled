...
{
	namespace_fe079222::register("MISSION_NEWWORLD_UNTOUCHED");
	namespace_fe079222::register("MISSION_NEWWORLD_SCORE");
	namespace_fe079222::register("MISSION_NEWWORLD_COLLECTIBLE");
	namespace_fe079222::register("MISSION_NEWWORLD_CHALLENGE3", "ch03_light_enemies_on_fire");
	namespace_fe079222::register("MISSION_NEWWORLD_CHALLENGE4", "ch04_wall_run_kills");
	namespace_fe079222::register("MISSION_NEWWORLD_CHALLENGE5", "ch05_penetrate_bullet_kills");
	namespace_fe079222::register("MISSION_NEWWORLD_CHALLENGE6", "ch06_cybercom_robot_kills");
	namespace_fe079222::register("MISSION_NEWWORLD_CHALLENGE7", "ch07_explosion_triple_kill");
	namespace_fe079222::register("MISSION_NEWWORLD_CHALLENGE8", "ch08_grenade_throwback_kill");
	namespace_fe079222::register("MISSION_NEWWORLD_CHALLENGE9", "ch09_icicle_kill");
	namespace_fe079222::register("MISSION_NEWWORLD_CHALLENGE10", "ch10_disabled_robot_kill");
	namespace_fe079222::register("MISSION_NEWWORLD_CHALLENGE11", "ch11_chase_no_reload");
	namespace_fe079222::register("MISSION_NEWWORLD_CHALLENGE12", "ch12_chase_no_civilians");
	namespace_fe079222::register("MISSION_NEWWORLD_CHALLENGE13", "ch13_turret_kill");
	namespace_fe079222::register("MISSION_NEWWORLD_CHALLENGE14", "ch14_shotgun_kills");
	namespace_fe079222::register("MISSION_NEWWORLD_CHALLENGE15", "ch15_wall_run_train");
...
function function_595dc718(params)
{
	if(isPlayer(params.eAttacker) && params.sMeansOfDeath == "MOD_BURNED")
	{
		...
		else if(params.eAttacker.var_6659e536 === params.eInflictor && !isdefined(self.var_93eeceb))
		{
...
function function_1b6f43c5(params)
{
	...
	if(isPlayer(params.eAttacker) && (params.sMeansOfDeath == "MOD_GRENADE" || params.sMeansOfDeath == "MOD_GRENADE_SPLASH" || params.sMeansOfDeath == "MOD_EXPLOSIVE" || params.sMeansOfDeath == "MOD_EXPLOSIVE_SPLASH" || params.sMeansOfDeath == "MOD_PROJECTILE" || params.sMeansOfDeath == "MOD_PROJECTILE_SPLASH"))
	{
		...
		else if(params.eAttacker.var_b5385d9d === params.eInflictor)
		{
...
function function_af529683()
{
	...
	self savegame::function_bee608f0("b_nw_accolade_11_failed", 1);
}
...
function function_2d344335()
{
	if(self savegame::function_36adbb9c("b_nw_accolade_11_failed") !== 1 && self savegame::function_36adbb9c("b_has_done_chase") !== 0 && self savegame::function_36adbb9c("b_nw_accolade_11_completed") !== 1)
	{
		...
		self savegame::function_bee608f0("b_nw_accolade_11_completed", 1);
	}
}
...
function function_bc7f04af(params)
{
	...
	{
		params.eAttacker savegame::function_bee608f0("b_nw_accolade_12_failed", 1);
	}
}
...
function function_829b12c4(params)
{
	...
	if(isdefined(self.archetype) && (self.archetype == "civilian" || self.archetype == "allies"))
	{
		...
		{
			var_efb53e77 savegame::function_bee608f0("b_nw_accolade_12_failed", 1);
		}
	}
}
...
function function_8af9d448()
{
	if(self savegame::function_36adbb9c("b_nw_accolade_12_failed") !== 1 && self savegame::function_36adbb9c("b_has_done_chase") !== 0 && self savegame::function_36adbb9c("b_nw_accolade_12_completed") !== 1)
	{
		...
		self savegame::function_bee608f0("b_nw_accolade_12_completed", 1);
	}
}
