...
{
	namespace_929c1dbf::function_e230521c();
...
function function_a56ceafc()
{
	...
	namespace_82b91a51::function_ef3f75eb("kw");
}
...
/*
	...
	Flags: None
*/
function function_9e8ca719(var_7d8d14c6, var_ca37d98d)
{
	if(!isdefined(var_ca37d98d))
	{
		var_ca37d98d = 0;
	}
	if(!isdefined(var_7d8d14c6))
	{
		return;
	}
...
{
	var_4dbf3ae3 = function_6ada35ba("amb_raven_fly", "targetname");
	if(isdefined(var_4dbf3ae3))
	{
		var_4dbf3ae3 waittill("hash_4dbf3ae3");
		wait(2);
		function_37cbcf1a("evt_raven_caw", (420, -2031, 590));
	}
}
...
{
	var_4dbf3ae3 = function_6ada35ba("amb_door_bang_silo_office", "targetname");
	if(isdefined(var_4dbf3ae3))
	{
		var_4dbf3ae3 waittill("hash_4dbf3ae3");
		wait(0.5);
		function_37cbcf1a("evt_door_bang", (660, -608, -1195));
	}
}
...
{
	var_4dbf3ae3 = function_6ada35ba("silo_door_scare", "targetname");
	if(isdefined(var_4dbf3ae3))
	{
		var_4dbf3ae3 waittill("hash_4dbf3ae3");
		wait(0.5);
		function_37cbcf1a("evt_silo_door_scare", (-780, 874, -2806));
	}
}
...
{
	var_4dbf3ae3 = function_6ada35ba("evt_metal_groan_undersilo", "targetname");
	if(isdefined(var_4dbf3ae3))
	{
		var_4dbf3ae3 waittill("hash_4dbf3ae3");
		wait(3);
		function_37cbcf1a("evt_dist_metal", (82, -863, -4551));
	}
}
...
{
	var_4dbf3ae3 = function_6ada35ba("evt_water_monster", "targetname");
	if(isdefined(var_4dbf3ae3))
	{
		var_4dbf3ae3 waittill("hash_4dbf3ae3");
		wait(0.5);
...
{
	var_4dbf3ae3 = function_6ada35ba("amb_robot_hallway", "targetname");
	if(isdefined(var_4dbf3ae3))
	{
		var_4dbf3ae3 waittill("hash_4dbf3ae3");
		wait(0.5);
		function_37cbcf1a("evt_robot_hallway", (216, -2624, -5120));
	}
}
...
{
	var_85d66a76 = function_99201f25("evt_underwater_exp", "targetname");
	for(var_c957f6b6 = 0; var_c957f6b6 < var_85d66a76.size; var_c957f6b6++)
	{
		var_85d66a76[var_c957f6b6] thread function_dc4d56aa();
	}
}
...
function function_dc4d56aa()
{
	...
	function_37cbcf1a(self.var_d47f13c, var_b07228b6.var_722885f3);
}
...
{
	var_7710e8e5 = function_99201f25("amb_underwater_bump", "targetname");
	for(var_c957f6b6 = 0; var_c957f6b6 < var_7710e8e5.size; var_c957f6b6++)
	{
		var_7710e8e5[var_c957f6b6] thread function_b08929ff();
	}
}
...
{
	self waittill("hash_4dbf3ae3");
	self function_921a1574(self.var_d47f13c);
}
...
{
	var_36784234 = function_99201f25("evt_robots_awaken", "targetname");
	for(var_c957f6b6 = 0; var_c957f6b6 < var_36784234.size; var_c957f6b6++)
	{
		var_36784234[var_c957f6b6] thread function_232d9e54();
	}
}
...
{
	self.var_e7020f3 = 0;
	level waittill("hash_2e6ff9d9");
	while(self.var_e7020f3 < 2)
	{
		wait(function_dc99997a(0, 4));
		self function_921a1574("evt_robots_awaken");
		self.var_e7020f3++;
	}
}
...
function function_4f035629()
{
	...
	var_a66f2065 = function_6ada35ba("amb_dni_chamber_origin", "targetname");
	if(isdefined(var_a66f2065))
	{
		var_a66f2065 function_c2931a36("amb_dni_chamber_hum", 0);
	}
}
...
function function_2b89e6e8()
{
	...
	function_37cbcf1a("fly_hendricks_kick_debris_beam_b", (-562, -326, -135));
}
...
{
	namespace_ccb8d056::function_c1cdedfb("quad_awaken");
}
...
{
	namespace_ccb8d056::function_c1cdedfb("genlab");
	level namespace_71e9cb84::function_74d6b22f("sndLabWalla", 0);
}
...
{
	wait(6);
	namespace_ccb8d056::function_c1cdedfb("knockbot");
}
...
{
	namespace_ccb8d056::function_c1cdedfb("pre_silo");
}
...
{
	namespace_ccb8d056::function_c1cdedfb("ambush");
}
...
{
	namespace_ccb8d056::function_c1cdedfb("corvus_entrance");
}
...
{
	namespace_ccb8d056::function_c1cdedfb("gas_battle_silo");
}
...
{
	namespace_ccb8d056::function_c1cdedfb("diaz_fight_part_one");
}
...
{
	namespace_ccb8d056::function_c1cdedfb("diaz_fight_part_two");
}
...
{
	namespace_ccb8d056::function_c1cdedfb("diaz_fight_part_three");
}
...
{
	wait(1);
	namespace_ccb8d056::function_c1cdedfb("defend_hendrix");
}
...
{
	wait(1);
	namespace_ccb8d056::function_c1cdedfb("depth_charge_ambience");
}
...
{
	wait(4);
	namespace_ccb8d056::function_c1cdedfb("silo_water");
}
...
{
	namespace_ccb8d056::function_c1cdedfb("robot_hallway");
}
...
{
	namespace_ccb8d056::function_c1cdedfb("robot_hallway_underscore");
}
...
function function_af9045f8()
{
	...
	namespace_ccb8d056::function_c1cdedfb("diaz_igc3");
}
...
{
	namespace_ccb8d056::function_c1cdedfb("dark_battle_stg");
}
...
{
	wait(2);
	namespace_ccb8d056::function_c1cdedfb("dni_lab_igc2");
}
...
{
	namespace_ccb8d056::function_c1cdedfb("flyin_igc1");
}
...
{
	wait(3);
	namespace_ccb8d056::function_c1cdedfb("hendricks_bodies");
}
...
{
	namespace_ccb8d056::function_c1cdedfb("descent");
}
...
{
	function_37cbcf1a("evt_sgen_hallway_scare", (182, -1189, -4560));
	var_a3d46ee4 = function_9b7fda5e("script_origin", (182, -1189, -4560));
	var_a3d46ee4 function_c2931a36("amb_sgen_corporate_jingle_scripted");
	wait(25);
	function_37cbcf1a("evt_sgen_hallway_scare_off", (182, -1189, -4560));
	var_a3d46ee4 function_eaa69754();
