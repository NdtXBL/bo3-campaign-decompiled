...
function autoexec function_c35e6aab()
{
	...
	if(!function_5dbf7eca(var_b78f06c4, "ramses"))
	{
		return;
	}
	namespace_c1b94c1e::function_e230521c();
...
{
	namespace_dabbe128::function_356a4ee1(&function_3e52c274);
}
...
{
	level endon("hash_4cb32f3c");
	level namespace_ad23e503::function_1ab5ebec("quad_tank_2_spawned");
	wait(1);
